...
subroutine compute_forces(i,iamgasi,iamdusti,xpartveci,hi,hi1,hi21,hi41,gradhi,gradsofti, &
 ...
 use part,        only:ndustsmall,grainsize,graindens,Bxyz,bxyzd,ndustsmall,grainsize,&
                       graindens,filfac
 ...
 use metric_tools,only:imet_minkowski,imetric,unpack_metric
 ...
 over_parts: do ip = inoderange(1,cell%icell),inoderange(2,cell%icell)
    ...
    if (iamtypei == isink .and. use_sinktree) then ! sink in the cell only need pos mass hsoft
       ...
       if (iamgasi) then
          ...
          cell%xpartvec(isyxi,cell%npcell)           = syxi
          cell%xpartvec(iszxi,cell%npcell)           = szxi
          cell%xpartvec(iszyi,cell%npcell)           = szyi
 ...
 over_parts: do ip = 1,cell%npcell
    ...
    isgas: if (iamgasi) then
       ...
       if (mhd) then
          ...
          !
          if (psidecayfac > 0. .and. .not. gr) then
